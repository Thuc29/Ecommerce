    ...
    const fetchNewProducts = async () => {
      try {
        ...
        const response = await axios.get(
          "https://ecommerce-6ssp.onrender.com/api/products/by-time?limit=8&sortBy=createdAt&sortOrder=desc"
        );
  ...
  useEffect(() => {
    const fetchTrendingProducts = async () => {
      try {
        ...
        const response = await axios.get(
          "https://ecommerce-6ssp.onrender.com/api/products/trending?limit=6"
        );
